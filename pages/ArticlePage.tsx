...
const ArticlePage: React.FC = () => {
  return (
    <div className="p-8 prose prose-invert prose-slate max-w-none prose-pre:bg-transparent prose-pre:p-0">
      <div className="flex justify-between items-center mb-8 not-prose">
        <h1 className="text-4xl font-bold text-white">Systemd</h1>
